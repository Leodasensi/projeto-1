...
DB_PATH = r"C:\Users\glaon\OneDrive\Documents\VS code\programação\VS code\projetos incompletos\promocoes.db"
...
def buscar_no_sqlite(db_path, limite=500):
    ...
    cursor.execute("""
        SELECT id as produto_id, titulo, url_original, url_afiliado,
